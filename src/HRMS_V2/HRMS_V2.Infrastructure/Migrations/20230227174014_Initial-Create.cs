        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    normalizedname = table.Column<string>(name: "normalized_name", type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastlogintime = table.Column<DateTime>(name: "last_login_time", type: "datetime2", nullable: false),
                    isworking = table.Column<bool>(name: "is_working", type: "bit", nullable: false),
                    username = table.Column<string>(name: "user_name", type: "nvarchar(256)", maxLength: 256, nullable: true),
                    normalizedusername = table.Column<string>(name: "normalized_user_name", type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    passwordhash = table.Column<string>(name: "password_hash", type: "nvarchar(max)", nullable: true),
                    ...
                    phonenumberconfirmed = table.Column<bool>(name: "phone_number_confirmed", type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    claimtype = table.Column<string>(name: "claim_type", type: "nvarchar(max)", nullable: true),
                    claimvalue = table.Column<string>(name: "claim_value", type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    providerdisplayname = table.Column<string>(name: "provider_display_name", type: "nvarchar(max)", nullable: true),
                    userid = table.Column<int>(name: "user_id", type: "int", nullable: false)
                },
                constraints: table =>
                {
